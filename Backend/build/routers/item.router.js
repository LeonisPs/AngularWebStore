    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                itemsCounts = _a.sent();
                if (itemsCounts > 0) {
                    res.send(data_1.sample_items);
                    return [2 /*return*/];
                }
                return [4 /*yield*/, item_model_1.ItemModel.create(data_1.sample_items)];
            case 2:
                _a.sent();
...
router.get("/search/:search", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var searchRegex, items;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                searchRegex = new RegExp(req.params.search, 'i');
