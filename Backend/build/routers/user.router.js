...
router.post('/register', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, name, address, user, encryptedPassword, newUser, dbUser;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                user = _b.sent();
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send('User already exists');
                    return [2 /*return*/];
                }
